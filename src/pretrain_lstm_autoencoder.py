...
def define_lstm_autoencoder_layers(embedding_matrix, vocab_size, feature_dimension_size, max_sequence_length, latent_feature_dimensions=32, loss="mse"):
    ...
    autoencoder.add(LSTM(latent_feature_dimensions*2, return_sequences=True, input_shape=(max_sequence_length, feature_dimension_size)))
    ...
    # decoder layers
    autoencoder.add(LSTM(latent_feature_dimensions, return_sequences=True))
