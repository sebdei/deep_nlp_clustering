...
def define_lstm_autoencoder_layers(embedding_matrix, vocab_size, feature_dimension_size, max_sequence_length, last_encoder_layer_key="last_encoder_layer"):
...
def pretrain_lstm_autoencoder():
    ...
    autoencoder = define_lstm_autoencoder_layers(
        ...
        last_encoder_layer_key=LAST_ENCODER_LAYER_KEY
        )
