...
FASTTEXT_PRETRAINED_MODEL_BASE_DIR = 'FastTextPreModel'
FASTTEXT_PRETRAINED_MODEL_TXT_NAME = 'crawl-300d-2M.vec'
FASTTEXT_PRETRAINED_MODEL_ZIP_NAME = 'crawl-300d-2M.vec.zip'
